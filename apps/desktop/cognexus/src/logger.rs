//! Production-grade logging for Cognexus desktop application.
//!
...
/// Log file name.
const LOG_FILE_NAME: &str = "cognexus.log";
...
pub fn initialize(log_dir: PathBuf) -> Result<(), CognexusError> {
...
fn initialize_internal(log_dir: PathBuf) -> Result<(), CognexusError> {
